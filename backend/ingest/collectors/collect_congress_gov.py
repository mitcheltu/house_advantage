...
# Maps committee name keywords to industry sectors for sector_overlap feature.
# First matching keyword wins (substring search), so more specific keywords
# come before general ones.  Cross-cutting committees (Appropriations, Budget,
# Rules, Ethics, Judiciary, etc.) intentionally have no match and stay NULL.
COMMITTEE_SECTOR_MAP = {
    ...
    "Space and Aeronautics": "tech",
    "Research and Technology": "tech",
    "Privacy": "tech",
    "Modernization": "tech",
    "Cyber": "tech",
    "Innovation": "tech",
